...
if(n_edge != 0){
  knitr::include_graphics("assets/network_FC_pvalue_OV90_CD73_vs_OV90_WT.png",  error = F)
}else{
  print("NOT enough data.")
}
```
...
if(enrich_map){
  knitr::include_graphics("assets/network_enrichmentmap_OV90_CD73_vs_OV90_WT.png",  error = F)
}else{
  print("NOT enough data.")
}
```
