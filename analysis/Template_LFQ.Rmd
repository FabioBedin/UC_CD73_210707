...
params:
  proteinGroups:
    label: "Input dataset:"
    value: proteinGroups_UC_CD73.txt
    input: file
  expdesign:
    label: "Experimental design:"
    value: experimentalDesignTemplate.txt
    input: file
  n_peptides: 
    label: "N° Peptides"
    value: 2
...
if(n_edge != 0){
  knitr::include_graphics("assets/network_FC_pvalue_OVCAR_CD73_vs_OVCAR_WT.png",  error = F)
}else{
  print("NOT enough data.")
}
```
...
if(enrich_map){
  knitr::include_graphics("assets/network_enrichmentmap_OVCAR_CD73_vs_OVCAR_WT.png",  error = F)
}else{
  print("NOT enough data.")
}
```
